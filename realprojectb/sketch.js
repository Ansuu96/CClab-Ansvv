...
function preload() {
  img = loadImage("../pictures/avdar.jpeg",
    () => console.log("LOADED"),
    ()=> console.log("FAILED")
  );
  //sound
...
sbSound = loadSound("sound/harvaa.mp3");
  ...
  img = loadImage("pictures/avdar.jpeg");
  for (let i = 1; i <= 2; i++) {
    img0.push(loadImage("pictures/harvaa" + i + ".jpeg"));
  }
  for (let i = 1; i <= 2; i++) {
    img1.push(loadImage("pictures/barildaan" + i + ".jpeg"));
  }

  for (let i = 1; i <= 2; i++) {
    img2.push(loadImage("pictures/sukhbaatar" + i + ".jpeg"));
  }
  for (let i = 1; i <= 2; i++) {
    img3.push(loadImage("pictures/uraldaan" + i + ".jpeg"));
  }
  for (let i = 1; i <= 3; i++) {
    img4.push(loadImage("pictures/tsam" + i + ".jpeg"));
  }
  for (let i = 1; i <= 3; i++) {
    img5.push(loadImage("pictures/tsereg" + i + ".jpeg"));
  }
}
